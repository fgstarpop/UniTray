    ...
    @else
        <div class="container pk-page">
            ...
            <div class="row">
                ...
                <hr style="height: 16px; background: #536280; margin-top: 0px;">
                ...
                <div class="col-12" style="padding-left: 0;">
                    ...
                    @foreach ($thanLongBang as $key => $playerTLB)
                        <div class="row table-than-long-element">
                            ...
                            <a href="{{ route('user.index', $playerTLB->get_users->id) }}"
                                class="fix-p" style="font-weight:bold;"> {{ $key + 1 }}
                                <img src="{{ $playerTLB->get_users->avatar ? pare_url_file($playerTLB->get_users->avatar, 'user') : 'frontend/images/no-user.png' }}"
                                    alt="" class="comment-avatar" style="margin-left: 0.8rem;" /> </a>
                            </div>
                            <div class="col-7">

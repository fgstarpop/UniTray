        ...
        <div class="bt">
            <a href="{{ $story->user_id ? route('user.index', $story->user_id) : '' }}" class="d-flex">
                <div class="position-relative">
                    ...
                    @else
                        <img src="frontend/images/no-user.webp" class="img-user">
                    @endif
                </div>
...
<div class="p-1 bg-white mt-2">
    ...
    @endif
     @if ((new \Jenssegers\Agent\Agent())->isMobile())
        ...
        <div> 
            <img src="{{ asset('/uploads/user/yeu-cau-dang-nhap-2.webp') }}" 
                alt="{{ setting('store_name', 'Giangthe.com') }}"  style=" width: 100%;" >   
                <hr style="height: 1px; background: #ffffff; margin-top: 0px;">
        </div>
        <div> <a href="https://zalo.me/0962759343" >
            <img src="{{ asset('/uploads/user/tang-chien-luc-1.webp') }}" 
                alt="{{ setting('store_name', 'Giangthe.com') }}"  style=" width: 100%;" >   
                <hr style="height: 3px; background: #ffffff; margin-top: 0px;">
        </div>

...
@section('scripts')
    ...
    {{--  <script src="http://127.0.0.1:5500/apps/frontend/audio.js?s=giangthe" id="js-audio"></script>  --}}
    <script src="https://api.truyenfox.net/plugins/audio.js?s=giangthe" id="js-audio"></script>
    <script>
        $.fn.extend({

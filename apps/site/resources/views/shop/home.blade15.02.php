...
@section('seo')
    ...
    <meta name="title" content="Giáng Thế - Đọc truyện sảng văn online miễn phí kết hợp tu tiên"/>
    <meta name="description" content="Đọc truyện online sảng văn, hài hước từ Trung Quốc miễn phí. Đủ các thể loại từ huyền huyễn, tiên võ, đô thị,...."/>
    <meta name="keywords" content="Đọc truyện sảng văn hài hước online"/>
    <meta property="og:url" content="https://giangthe.com/"/>
    <meta property="og:title" content="Giáng Thế - Đọc truyện sảng văn online miễn phí kết hợp tu tiên"/>
    <meta property="og:locale" content= "vi"/>
    <meta property="og:description" content="Đọc truyện online sảng văn, hài hước từ Trung Quốc miễn phí. Đủ các thể loại từ huyền huyễn, tiên võ, đô thị,...."/>
        ...
        <section class="content container mt-2 search-section" style="min-height: unset">
            ...
            <div class="col-12" style="display: grid; grid-template-columns: repeat(4, 1fr); grid-gap: 20px">
                ...
                <a href="{{ route('pk.packTuLuyen') }}" class="d-flex flex-column align-items-center text-danger">
                    <img src="{{ asset('frontend/images/mobile/50.webp') }}" alt=""
                         style="width: 29px;">
                ...
                <a data-bs-toggle="modal" data-bs-target="#tim-kiem" class="d-flex flex-column align-items-center text-danger">
                    <img src="{{ asset('frontend/images/mobile/vs.webp') }}" alt=""
                         style="width: 29px;">
                        ...
                        <div class="update-section">
                            ...
                            <ul style="max-height: 435px;overflow: auto" class="home-scroll">
                                @foreach ($storyNew as $storyWritten)
                                    <li class="row">
                                        @if ($storyWritten)
                                            <a href="{{ route('story.show', $storyWritten) }}" class="">
                                                <div class="img col-md-1" style="margin-left:-10px">
                                                    <img data-src="{{ $storyWritten->avatar ?? $storyWritten->getFirstMediaUrl('default') }}"
                                                        class="lazyload" alt="{{ $storyWritten->name }}">
                                                </div>
                                                <div class="title col-md-9">
                                                    <b> {{ $storyWritten->name }} </b>
                                                    <p class="fs-12">{{ $storyWritten->user()->name ?? '' }}</p>
                                                </div>
                                                <div class="time col-md-5">
                                                    <i>{{ formatDayMonthYear($storyWritten->created_at) }}</i>
                                                </div>
                                            </a>
                                        @endif
                                    </li>
                        ...
                        <div class="chat-header">
                            ...
                            <div class="chat-body home-scroll">
                                <iframe src="https://www5.cbox.ws/box/?boxid=930287&boxtag=brZbTV" width="100%"
                                    height="620" allowtransparency="yes" allow="autoplay" frameborder="0"
        ...
        <div class="col-12 mb-2">
            <div class="home-section">
                <div class="home-header bg-home-2 d-flex justify-content-between align-items-center">
                    ...
                    <span class="fs-4 text-white font-weight-bold">{{ 'Top Thưởng Tuần' }}</span>
            ...
            <div class="col-12 mb-2">
                <div class="home-section">
                    <div class="home-header bg-home-2 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('embedChapter', ['view' => 50000]) }}"
                           style="font-size: 13px; font-weight: 300"
                           class="view-all text-white"><u></u></a>
                    </div>
                    <div class="row px-2">
...
{{--    Ranking--}}
    <style>
        .ranking .modal-dialog .modal-content {
            background: url("{{ asset('frontend/images/ranking-bg.webp') }}");
                                        ...
                                        <a href="{{ route('user.index', $user['id']) }}"
                                           class="user d-flex justify-content-between text-white">
                                            <div class="thumb position-relative">
                                                ...
                                                @if($user['is_vip'] == 1)
                                                    <img src="{{ asset('frontend/images/mod.webp') }}"
                                                         height="15px" width="auto"
                                                         style="bottom: 0; left: 50%; transform: translate(-50%, 50%)"
                                                         alt="Honor" class="honor position-absolute">
                                                @elseif($user['user_vip'] == 1)
                                                    <img src="{{ asset('frontend/images/user_vip.webp') }}"
                                                         height="15px" width="auto"
                                                         style="bottom: 0; left: 50%; transform: translate(-50%, 50%)"
                                                         alt="Honor" class="honor position-absolute">
                                                @endif

                    ...
                    <div class="d-flex comment list{{$list->id}} val{{$list->id}} comment-box-mobile">
                        <div class="img-cmt-block d-flex flex-column avt-box-mobile">
                            ...
                            @elseif ($list->users->user_vip == 1)
                                <img style="width: 50px;" class="mt-1 tag-vip" src="{{ asset('frontend/images/user_vip.webp') }}" alt="">
                            @endif
                        </div>
                                ...
                                <div class="d-flex val{{$val->id}} childVal{{$list->id}} child-cmt-desktop">
                                    <div class="img-cmt-block d-flex flex-column avt-box-mobile">
                                        ...
                                        @elseif ($val->users->user_vip == 1)
                                            <img style="width: 50px;" class="mt-1" src="{{ asset('frontend/images/user_vip.webp') }}" alt="">
                                        @endif
                                    </div>
            ...
            success: function (res) {
                ...
                if (res.status == 300) {
                    ...
                    let vipAvatarClass = res.user.user_vip == 1 ? 'border-vip' : '',
                        ...
                        modIconClass = res.user.is_vip == 1 ? '<img style="width: 50px;" class="mt-1" src="{{ asset('frontend/images/mod.webp') }}" alt="">' : res.users.user_vip == 1 ? '<img style="width: 50px;" class="mt-1" src="{{ asset('frontend/images/user_vip.webp') }}" alt="">' : '',

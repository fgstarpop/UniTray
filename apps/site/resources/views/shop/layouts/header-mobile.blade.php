...
<header>
    ...
    <div class="header header-mobile">
        <div class="back-gr-mobile" style="height: 100%;overflow: hidden;"><img
                src="{{ asset('frontend/images/mobile/backgroundmbi.png') }}"
        ...
        <div class="container">
            <div class="row" style="display: flex; align-items: center;">
                ...
                {{--                    <a class="nav-icon"><img src="frontend/images/nav-icon.webp" alt=""></a> --}}
                {{--                </div> --}}
            ...
            <div class="modal fade" id="in-pk" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content"
                        style="background-image: url(/asset/pk/lh.webp);
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
             ...
             aria-hidden="true" style="font-size: 15px;">
             <div class="modal-dialog modal-dialog-centered modal-md">
                 <div class="modal-content" style="background-image: url(/asset/pk/lh.webp);
                 background-size: cover;
                 border: solid #cdcd1b 1px;
                 height: 540px;">
                     <div class="modal-header" style="flex-direction: column-reverse;
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body position-relative">
                                <img src="{{ asset('frontend/images/logo-vip.webp') }}" alt="Logo vip"
            ...
            <div class="modal-content" style="background: transparent;border: none;">
                ...
                <div class="modal-body">
                    <div class="position-relative text-center" id="lucky-modal" onclick="confirmEarn()">
                        <img src="{{ asset('frontend/images/lixi_ads_gift.webp') }}" alt="Lixi" height="400px">

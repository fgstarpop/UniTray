...
class PKController
{
	...
	public function xorIndex()
    {
        return view('xor');
    }

    public function Xor(Request $request)
    {
        $input_text = $request->input('input_text');
        $input_number = intval($input_text);
        $result = $input_number ^ 444444;
        return view('xor', ['result' => $result, 'input_text' => $input_text]);
    }

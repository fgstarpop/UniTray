...
Route::middleware(['filter','throttle:20,1'])->get('/doc-truyen/{story:id}', [\App\Http\Controllers\Shop\ChapterController::class, 'show'])->name('chapters.show');
...
Route::prefix('user')->name('user.')->middleware('user')->group(function () {
    ...
    Route::post('/order/chapter', [OrderController::class, 'chapter'])->middleware(["throttle:20,1"])->name('order.chapter');
